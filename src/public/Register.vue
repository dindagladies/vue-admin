<template>
    <form class="form-signin" @submit.prevent="submit">
        ...
        <input type="email" id="inputEmail" class="form-control" placeholder="Email" required v-model="email">
        <!-- password -->
    ...
    export default {
        ...
        setup(){
            ...
            const submit = async () => {
                ...
                // afer input, go to login page
                await router.push('/login')
            }

            // connectin template to variable
            return {
                firstName,
                lastName,
                email,
                password,
                passwordConfirm,
                // should return the function too, to connect the template
                submit
            }
        }
    }
